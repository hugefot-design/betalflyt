          ...
          <div className="flex flex-col gap-10">
            ...
            <div>
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <a className="btn btn-primary" href="/no/pricing">
                  Prøv Pro gratis i 30 dager
                </a>
                <a className="btn" href="/no/generator">
                  Start generator
                </a>
              ...
              <div className="mt-3 text-xs text-black/55">Uten kort. Ingen binding. Fortsett gratis etterpå.</div>
            </div>
            ...
            <section>
              ...
              <div className="mt-4 flex flex-wrap gap-x-5 gap-y-2 text-xs text-black/55">
                <a className="link" href="/no/privacy">
                  Personvern
                </a>
                <a className="link" href="/no/terms">
                  Vilkår
                </a>
            ...
            <div className="flex flex-wrap items-center justify-between gap-x-5 gap-y-2 text-xs text-black/55">
              ...
              <div className="flex flex-wrap gap-x-5 gap-y-2">
                <a className="link" href="/no/pricing">
                  Pris
                </a>
                <a className="link" href="/no/generator">
                  Generator
                </a>
                <a className="link" href="/no/privacy">
                  Personvern
