export default function PricingPageNO() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-4 py-16">
        <div className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-2 text-zinc-600">
            Generatoren er gratis. Vi tjener penger på Pro-funksjoner som gjør det enklere å få betalt (status,
            påminnelser/purring og kundeportal).
          </p>
          ...
          <p className="mt-8 text-xs text-zinc-500">Ingen spam. Kun oppdateringer om nye funksjoner.</p>
        </div>
      </div>
    </div>
  );
