      ...
      <div className="mx-auto max-w-4xl px-4 py-16">
        <div className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-2 text-zinc-600">
            Fakturageneratoren er gratis. Pro-funksjoner (purring, status og kundeportal) kommer snart.
          </p>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            ...
            <Plan
              ...
              price="$9/mo"
              bullets={["Invoice tracking", "Reminders", "Branded customer portal"]}
              ctaText="Join waitlist"
              ctaHref="mailto:hello@invoicespark.app?subject=InvoiceSpark%20Pro%20waitlist"
            />
          </div>

          <p className="mt-8 text-xs text-zinc-500">
            Note: Prices are placeholders for MVP.
          </p>
        </div>
      </div>
    </div>
